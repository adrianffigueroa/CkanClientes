...
export default function LoginForm() {
  ...
  return (
    <section className="flex justify-center mt-10 w-full relative">
      <div className="absolute inset-0">
        <div className="w-[115%] mt-21 translate-x-[7.5%] bg-[rgba(74,58,255,0.03)] rounded-t-3xl min-h-full"></div>
      </div>
